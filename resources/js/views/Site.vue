...
<script>
    ...
    import InstallRepository from '../components/site/InstallRepository.vue';
    import Deployment from '../components/site/Deployment.vue';
    import DeployScript from '../components/site/DeployScript.vue';
